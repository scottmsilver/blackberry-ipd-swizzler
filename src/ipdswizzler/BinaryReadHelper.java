...
class BinaryReadHelper {
	...
	String getNullTerminatedString(String fieldName, int length)
		...
		String string = new String(field, 0, length - 1,
	...
	public int getInt32(boolean bigEndian, String fieldName) throws IOException {
		...
		if (!bigEndian) {
			returnField = (field >>> 24) | (field << 24)
					| ((field << 8) & 0xff0000) | ((field >> 8) & 0xff00);
		}
	...
	public byte[] getBytes(int fieldLength, String fieldName)
			throws IOException {
